...
public class Institution extends Model {	
	...
	public boolean isAdmin(User user) {
		return user.role == User.Role.ADMIN && user.institution.id == this.id;
	}
	...
	// Get all Institutions a given student is enrolled in
	...
	// can view/edit/delete all courses at the institution
	public boolean canControlAllCourses(User user) {
		return this.isAdmin(user);
	}


	// can view/edit/delete all instructors at the institution
	public boolean canControlAllInstructors(User user) {
		return this.isAdmin(user);
	}
}